...
public class SimulationConfiguration {
  ...
  // TODO revert
  public static final int NUM_OF_NODES =
      Integer.parseInt(System.getProperty("nodes", "500")); // 600;//800;//6000;
   ...
   */
  public static final long INTERVAL = 6000; // 1000*60;//1000*30*5;//1000*60*10;
  ...
  public static final long BLOCK_SIZE =
      Long.parseLong(System.getProperty("blocksize", "125000")); // 6110;//8000;//535000;//0.5MB

  /** The usage rate of compact block relay (CBR) protocol. */
  public static final float CBR_USAGE_RATE = 0.0f;
